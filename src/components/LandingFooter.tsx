      ...
      <Container className={classes.inner} size="lg">
        <div className={classes.logo}>
          <Stack align="flex-start">
            ...
            <Text size="sm">
              <strong>CauseConnect</strong> is India's crowdfunding platform to raise
              funds for anything that matters to you — from personal needs and
              medical expenses to NGOs, education, and community projects.
            </Text>
          </Stack>
        </div>
