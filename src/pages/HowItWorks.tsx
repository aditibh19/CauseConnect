      ...
      <Box>
        <Container>
          <Box {...boxProps} sx={{ textAlign: "center" }}>
            ...
            <Text>
              GoGetFunding is the best place to fundraise, whether you are an
          ...
          <Box {...boxProps}>
            ...
            >
              <Card {...cardProps}>
                <Card.Section>
                  <Image src={AddImg} alt="Start your fundraiser illustration" {...imageProps} />
                </Card.Section>
                <Text my="sm" fw={600}>
              ...
              <Card {...cardProps}>
                <Card.Section>
                  <Image src={MoneyImg} alt="Share with friends illustration" {...imageProps} />
                </Card.Section>
                <Text my="sm" fw={600}>
              ...
              <Card {...cardProps}>
                <Card.Section>
                  <Image src={ShareImg} alt="Manage donations illustration" {...imageProps} />
                </Card.Section>
                <Text my="sm" fw={600}>
                  3. Manage donations
                </Text>
          ...
          <Box {...boxProps}>
            ...
            >
              <Card shadow="md" radius="sm" component={Link} to="/campaigns">
                <Card.Section>
                  <Image
                ...
                <Stack spacing="sm" align="start" mt="md">
                  ...
                  <Button size="md" component={Link} to="/campaigns">
                    Fund Someone
                  </Button>
                </Stack>
              </Card>
              <Card shadow="md" radius="sm" component={Link} to="/create-campaign">
                <Card.Section>
                  <Image
                    ...
                    alt="Create your campaign illustration"
                  />
                </Card.Section>
                <Stack spacing="sm" align="start" mt="md">
                  <Text size="lg" fw={500}>
                  ...
                  <Button size="md" component={Link} to="/create-campaign">
                    Start Fundraising
                  </Button>
                </Stack>
              </Card>
